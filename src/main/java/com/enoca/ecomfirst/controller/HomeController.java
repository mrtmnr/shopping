...
import com.enoca.ecomfirst.DTOs.SignupRequest;
...
import static com.enoca.ecomfirst.Enums.EnumRole.ADMIN;
            ...
            strRoles.forEach(role -> {
                switch (role) {
                    case "admin":
                        ...
                        break;
                    case "customer":
                        Role customerRole = roleRepository.findByName(EnumRole.CUSTOMER)
                                .orElseThrow(() -> new RuntimeException("Error: Role is not found."));
